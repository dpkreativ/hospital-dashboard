  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="container px-4 py-24 md:px-6 border-t">
          <div className="grid gap-12">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-500">
                  Track recovery progress, monitor vital signs, and stay
                  connected with your healthcare team after surgical procedures
                  for optimal healing.
                </p>
              </div>
              <div className="space-y-4">
        ...
        <section className="border-t">
          <div className="container grid items-center gap-6 px-4 py-24 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">
                Join healthcare professionals worldwide
              </h2>
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Transform patient care with our comprehensive vital monitoring
                platform.
              </p>
            </div>
